...
import { buildSkillGapAnalysis, buildSuggestions, buildImprovementPlan, buildFormattingChecks } from './ats/suggestionsEngine.js';
...
export async function analyzeResumeAgainstJob(resumeText, jobDescription) {
  ...
  return {
    ...
    improvementPlan,
    formattingChecks: buildFormattingChecks({ sections, resumeWordCount }),
  };
}

...
const Portfolio: React.FC = () => {
  ...
  return (
    <div className="space-y-4 flex flex-col min-h-0" style={{ height: 'calc(100vh - 108px)' }}>
      <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[230px_minmax(300px,0.9fr)_minmax(360px,1.25fr)] gap-4 flex-1 min-h-0">
        <aside className="rounded-2xl overflow-hidden flex min-h-0 flex-col" style={{ background: 'var(--bg-sidebar)', color: 'var(--text-primary)', border: '1px solid var(--border)' }}>
          <div className="p-5 border-b" style={{ borderBottomColor: 'var(--border)' }}>
            <p className="font-bold text-2xl">Portfolio-Maker</p>
          </div>
          <nav className="p-3 space-y-1 flex-1 min-h-0">
        ...
        <section className="rounded-2xl overflow-hidden flex min-h-0 flex-col" style={{ border: '1px solid var(--border)', background: 'var(--bg-card)' }}>
          <div className="p-5 border-b" style={{ borderBottomColor: 'var(--border)' }}>

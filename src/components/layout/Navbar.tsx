...
const Navbar: React.FC<NavbarProps> = ({ onMenuClick }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-16 border-b" style={{ background: 'var(--bg-card)', borderBottomColor: 'var(--border)' }}>
      <div className="flex items-center justify-between h-full px-6">
        <div className="flex items-center space-x-4">
          ...
          <Link to="/" className="flex items-center gap-2 leading-tight" style={{ color: 'var(--text-primary)' }}>
            <BrandLogo size="sm" />
          </Link>
